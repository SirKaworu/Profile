...
class EducationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'judul.required' => 'Almamater wajib diisi',
                'info1.required' => 'Almamater wajib diisi',
        ...
        return redirect()->route('education.index')->with('success', 'Input Data berhasil !');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Update Data berhasil !');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Delete Data berhasil !');
    }
}
