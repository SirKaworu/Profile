...
class ExperienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Input Data berhasil !');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Update Data berhasil !');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Delete Data berhasil !');
    }
}
