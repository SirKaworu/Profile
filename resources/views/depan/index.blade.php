        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    {{ get_meta_value('_domisili') }} . {{ get_meta_value('_nohp') }} . <a
                        href="mailto:name@email.com">{{ get_meta_value('_email') }}</a>
                </div>
                <div class="lead mb-5">
                    {!! $about->isi !!}
                </div>
                <div class="social-icons">
                    ...
                    <a class="social-icon" href="{{ get_meta_value('_youtube') }}"><i class="fab fa-youtube"></i></a>
            ...
            <div class="resume-section-content">
                ...
                @foreach ($experience as $item)
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">{{ $item->tgl_mulai_default }} -
                                {{ $item->tgl_akhir_default }}</span></div>
                    </div>
                @endforeach
            </div>
        </section>
