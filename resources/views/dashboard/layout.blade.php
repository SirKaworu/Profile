...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="{{ asset('admin') }}/images/icons8-yin-yang-96.png" />
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="{{ asset('admin') }}/index.html"><img
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © by
                            Steven 2023</span>
                    </div>
                </footer>
                <!-- partial -->
